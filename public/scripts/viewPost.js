...
document.addEventListener('DOMContentLoaded', () => {
    const searchInput = document.getElementById('post-search-1');
    const postContainer = document.getElementById('postDetailContainer'); // Assuming this contains your posts
